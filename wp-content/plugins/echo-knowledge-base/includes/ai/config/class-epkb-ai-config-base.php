...
abstract class EPKB_AI_Config_Base {
	...
	public static function update_config( $new_config ) {
		...
		// Let subclasses invalidate any caches that derive from this option; do not seed the cache here -
		// $validated_config holds unmasked API keys and get_ai_config() callers expect masked keys
		static::clear_cache();
