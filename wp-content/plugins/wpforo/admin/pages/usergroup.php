...
<div id="wpf-admin-wrap" class="wrap">
        ...
        <form method="POST" class="wpforo-ajax-form">
            <table id="usergroup_table" class="wp-list-table widefat fixed posts">
                ...
                <tr>
                    ...
                    <th scope="col" id="default" class="manage-column column-title" style="padding:10px; font-size:14px; padding-left:15px; font-weight:bold;"><span><?php _e(
								'Default',
								'wpforo'
							) ?></span></th>
                    <th scope="col" id="access" class="manage-column column-title" style="padding:10px; font-size:14px; padding-left:15px; font-weight:bold;"><span><?php _e(
								'Default Access',
								'wpforo'
							) ?></span></th>
                    <th scope="col" id="color" class="manage-column column-title" style="padding:10px; font-size:14px; padding-left:15px; font-weight:bold;"><span><?php _e(
								'Color',
								'wpforo'
							) ?></span></th>
                    <th scope="col" id="id" class="manage-column column-title" style="padding:10px; width: 4%; font-size:14px; padding-left:15px; font-weight:bold; text-align: center;"><span><?php _e(
								'ID',
								'wpforo'
							) ?></span></th>
                </tr>
                    ...
                    <tr id="usergroup-<?php echo intval( $group['groupid'] ) ?>" class="format-standard hentry alternate iedit" valign="top">
						<?php if( wpforo_setting( 'authorization', 'role_synch' ) ): ?>
                            <td class="post-title page-title column-title" style="border-bottom:1px dotted #CCCCCC; padding-left:20px;">
								...
								$ug_role = ( wp_roles()->is_role( $ug_role ) ) ? $ug_role = '<a href="' . admin_url( 'users.php?role=' . $group['role'] ) . '" title="' . __(
										'View Users',
										'wpforo'
                        ...
                        <td class="post-title page-title column-title" style="border-bottom:1px dotted #CCCCCC; padding-left:20px; background:#ffffff;">
							<?php $edit_url = ( $group['groupid'] != 1 ? admin_url(
								'admin.php?page=' . wpforo_prefix_slug( 'usergroups' ) . '&groupid=' . $group['groupid'] . '&wpfaction=wpforo_usergroup_save_form'
							) : '#' ) ?>
                            <strong>
                                <a class="row-title" href="<?php echo esc_url( (string) $edit_url ) ?>" title="<?php _e( 'Usergroup Name', 'wpforo' ) ?>">
									<?php echo esc_html( $group['name'] ) ?>
                                </a> <?php if( wpfval( $group, 'secondary' ) ): ?>&nbsp;<span style="font-size: 12px; color: #777777;" title="<?php _e( 'Also used as Secondary Usergroup' ); ?>"><i
                                            class="fas fa-pause"></i></span><?php endif; ?>
                            </strong>
                            <div class="row-actions">
                                <span class="edit"><a title="<?php _e( 'Edit this usergroup', 'wpforo' ) ?>" href="<?php echo admin_url(
		                                'admin.php?page=' . wpforo_prefix_slug( 'usergroups' ) . '&groupid=' . intval( $group['groupid'] ) . '&wpfaction=wpforo_usergroup_save_form'
	                                ) ?>"><?php _e( 'Edit', 'wpforo' ) ?></a> |</span>
								<?php if( $group['groupid'] > 5 ): ?>
                                    <span class="trash"><a class="submitdelete" title="<?php _e( 'Delete this usergroup', 'wpforo' ) ?>" href="<?php echo admin_url(
											'admin.php?page=' . wpforo_prefix_slug( 'usergroups' ) . '&groupid=' . intval( $group['groupid'] ) . '&wpfaction=usergroup_delete_form'
										) ?>"><?php _e( 'Delete', 'wpforo' ) ?></a> |</span>
								<?php endif; ?>
                                <span class="view"><a title="<?php _e( 'View users list in this usergroup', 'wpforo' ) ?>"
                                                      href="<?php echo admin_url( 'admin.php?page=' . wpforo_prefix_slug( 'members' ) . '&filter_by_group=' . intval( $group['groupid'] ) ) ?>"
                                                      rel="permalink"><?php _e( 'View', 'wpforo' ) ?></a></span>
                            </div>
                        </td>
                        <td class="column-title" style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding-left:20px; background:#ffffff;">
							<?php if( $group['groupid'] != 4 ) : ?>
                                <strong><a class="row-title" href="<?php echo admin_url( 'admin.php?page=' . wpforo_prefix_slug( 'members' ) . '&filter_by_group=' . intval( $group['groupid'] ) ) ?>"
                                           title="<?php _e( 'The number of forum members with this usergroup. Click to view members.', 'wpforo' ) ?>"><i
                                                class="fas fa-user"></i>&nbsp; <?php echo intval( $group['count'] ) ?></a></strong>
							<?php endif; ?>
                        </td>
                        <td class="column-title" style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding-left:20px; background:#ffffff;">
                            <strong style="color: #00a636">
								...
								<?php else : ?>
                                    <a class="row-title" href="<?php echo wp_nonce_url(
										admin_url( 'admin.php?page=' . wpforo_prefix_slug( 'usergroups' ) . '&wpfaction=default_groupid_change&default_groupid=' . intval( $group['groupid'] ) ),
										'wpforo-default-groupid-change-' . intval( $group['groupid'] )
									) ?>" title="<?php _e( 'Users get the Default Usergroup on registration', 'wpforo' ) ?>"><?php _e( 'Set as Default', 'wpforo' ) ?></a>
								<?php endif ?>
                            </strong>
                        </td>
                        <td class="column-title" style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding-left:20px; background:#ffffff;">
                            <strong><?php echo wpfval( WPF()->perm->accesses, $group['access'], 'title' ); ?></strong>
                        </td>
                        <td class="column-title" style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding-left:20px; background:#ffffff;">
                            <strong><?php if( ! isset( $group['color'] ) || ! $group['color'] ): ?><?php _e( 'default (#15)', 'wpforo' ) ?><?php else: ?><input type="color"
                                                                                                                                                                value="<?php echo $group['color'] ?>"
                                                                                                                                                                disabled /><?php endif; ?></strong>
                        </td>
                ...
                <tr>
					...
					<?php endif; ?>
                    <td colspan="6" style="text-align:left; vertical-align: middle; padding:10px 20px;"><span class="wpf-progress"
                                                                                                              style="font-size: 14px; display: inline-block; font-weight: 600; line-height: 18px;">&nbsp;</span>
                    </td>
                </tr>
                </tfoot>
            </table>
	...
	<?php if( ! empty( $roles_wug ) ): ?>
        ...
        <table id="usergroup_table" class="wp-list-table widefat fixed posts">
            <thead>
            <tr>
                <th scope="col" id="role" class="manage-column column-title" style="padding:10px; font-size:14px; padding-left:15px; font-weight:bold;"><span><?php _e(
							'Role Name',
							'wpforo'
						) ?></span></th>
                <th scope="col" id="id" class="manage-column column-title" style="padding:10px; font-size:14px; padding-left:15px; font-weight:bold;"><span><?php _e( 'User Role', 'wpforo' ) ?></span>
                </th>
                <th scope="col" id="title" class="manage-column column-title" style="padding:10px; font-size:14px; padding-left:15px; font-weight:bold;"><span><?php _e(
							'Usergroups',
							'wpforo'
						) ?></span></th>
                <th scope="col" id="count" class="manage-column column-title" style="padding:10px; font-size:14px; padding-left:15px; font-weight:bold;"><span><?php _e( 'Users', 'wpforo' ) ?></span>
                </th>
                <th scope="col" id="default" class="manage-column column-title" style="padding:10px; font-size:14px; padding-left:15px; font-weight:bold; width: 40%;"><span><?php _e(
						'Status',
						'wpforo'
					) ?></th>
            </tr>
			...
			<?php foreach( $roles_wug as $role_key => $role_name ): ?>
                <tr>
                    <td class="column-title"
                        style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding-left:20px; background:#F9F9F9; font-weight: 600; font-size: 14px;"><?php echo $role_name; ?></td>
                    <td class="column-title"
                        style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding-left:20px; background:#ffffff; color: #c420fa; font-weight: 600;"><?php echo $role_key; ?></td>
                    <td class="column-title" style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding-left:20px; background:#ffffff;"><?php echo ( wpfval(
							$roles_ug,
							$role_key
						) ) ? '<span style="color:#43a6df; font-weight: 600;">' . implode( ', ', $roles_ug[ $role_key ] ) . '</span>' : 'default'; ?></td>
                    <td class="column-title" style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding-left:20px; background:#ffffff; font-weight: 600; font-size: 14px;">
						<?php echo ( wpfval( $roles_users, 'avail_roles' ) && wpfval( $roles_users, 'avail_roles', $role_key ) && $roles_users['avail_roles'][ $role_key ] ) ? '<a href="' . admin_url(
								'users.php?role=' . $role_key
							) . '" title="' . __( 'View Users', 'wpforo' ) . '" target="_blank"><i class="far fa-user"></i> &nbsp;' . intval(
							                                                                                                                                                       $roles_users['avail_roles'][ $role_key ]
						                                                                                                                                                       ) . '</a>' : 0; ?>
                    </td>
                    <td class="column-title" style="border-bottom:1px dotted #CCCCCC; vertical-align:middle; padding:10px; background:#ffffff;">
						<?php if( ! wpfval( $roles_ug, $role_key ) ): ?>
                            <a href="<?php echo admin_url( 'admin.php?page=' . wpforo_prefix_slug( 'usergroups' ) . '&wpfaction=wpforo_usergroup_save_form&role=' . $role_key ) ?>" class="add-new-h2"
                               style="display: inline-block; vertical-align: middle; top: 0;"><?php _e( 'Add Usergroup to synch', 'wpforo' ) ?></a>
                    ...
                    <div style="width:100%; margin-bottom:12px;">
                        <div style="display:block; float:left; padding-right:20px; width:30%; padding-bottom:15px;">
                            ...
                            <input name="usergroup[name]" <?php echo $group['groupid'] === 4 ? 'type="hidden"' : 'type="text"'; ?> value="<?php echo esc_attr( $group['name'] ) ?>" required
                                   style="background:#FDFDFD; min-width:320px;">
                            <div style="display:inline-block; margin-top:10px;">
                                <label for="wpf_usergroup_color" style="display:inline-block;"><?php _e( 'Usergroup Color', 'wpforo' ) ?>: </label>
                                <input id="wpf_usergroup_color" style="display:inline-block; vertical-align:middle; width:100px;" type="color" name="usergroup[color]" onchange=""
                                       value="<?php echo $group['color'] ?>">
                                <input id="wpf_usergroup_colorx" style="display:inline-block; vertical-align:middle; width:100px; padding:1px 5px;" type="text" name="usergroup[colorx]" maxlength="7"
                                       value="<?php echo $group['color'] ?>">
                    ...
                    <table class="wpf-table-box-left" style="margin-right:15px; margin-bottom:15px;  min-width:320px;">
                        ...
                        <tr>
                            ...
                            <td class="wpf-dw-td-value">
                                <input id="wpf-can-<?php echo esc_attr( $can ) ?>" type="checkbox" value="1"
                                       name="usergroup[cans][<?php echo esc_attr( $can ) ?>]" <?php echo $group['cans'][ $can ] ? 'checked' : '' ?>>
                            </td>
                        </tr>
						<?php $n ++;
						endforeach; ?>
