            ...
            <div class="wpf-board-left">
                ...
                <div class="wpf-board-modules">
                    ...
                    <?php foreach( wpforo_get_modules_info(false) as $key => $module ) :
                        $is_module_enabled = wpforo_is_module_enabled( $key, $board );
                        ?>
                        <div class="wpf-board-module">
                            <div class="wpf-module-head">
                                <?php if( strpos((string) $module['thumb'], '<svg') === FALSE ): ?>
                            ...
                            <div>
                                ...
                                <div class="wpf-switch-field">
                                    <input type="radio" value="1" name="board[modules][<?php echo $key ?>]" id="wpf-board-<?php echo $key ?>_1" <?php wpfo_check( $is_module_enabled, true ); ?>><label for="wpf-board-<?php echo $key ?>_1"><?php _e( 'Enabled', 'wpforo' ) ?></label> &nbsp;
                                    <input type="radio" value="0" name="board[modules][<?php echo $key ?>]" id="wpf-board-<?php echo $key ?>_0" <?php wpfo_check( $is_module_enabled, false ); ?>><label for="wpf-board-<?php echo $key ?>_0"><?php _e( 'Disabled', 'wpforo' ) ?></label>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
                    ...
                    <?php foreach( wpforo_get_addons_info(false) as $key => $addon ) :
                        ...
                        <div class="wpf-board-module">
                            <div class="wpf-module-head">
                                <?php if( strpos((string) $addon['thumb'], '<svg') === FALSE ): ?>
